...
import { calculateGentleStreak, awardXP, XP_REWARDS, LEVEL_THRESHOLDS, calculateLevel, xpToNextLevel, getStreakBonusXP, getYearlyHeatmap, } from '../src/services/streak.service';
// ─── Helpers ────────────────────────────────────────────────────────────────────
const daysAgo = (n) => {
    const d = new Date();
