    ...
    const stats = [
        {
            ...
            value: isSummaryLoading ? '...' : `${summaryData?.stats.totalHours}h`,
            trend: '+12%',
            icon: Clock,
            gradient: 'from-cyan-500 to-blue-500',
        },
        {
            ...
            value: isSummaryLoading ? '...' : `${summaryData?.stats.totalMinutes}m`,
            trend: '+2',
            icon: CheckCircle,
            gradient: 'from-purple-500 to-pink-500',
        },
        {
            ...
            value: isFocusLoading ? '...' : `${focusScoreData?.stats.score} / 100`,
            trend: '+5pts',
            icon: Target,
            gradient: 'from-green-500 to-emerald-500',
        },
        {
            ...
            value: isSummaryLoading ? '...' : `${Math.round(((summaryData?.stats.totalHours || 0) / (summaryData?.stats.dailyGoalHours || 1)) * 100)}%`,
            trend: 'Target',
            icon: TrendingUp,
            gradient: 'from-orange-500 to-red-500',
        },
