        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48 bg-slate-900 border-white/10 text-slate-200">
                    ...
                    <DropdownMenuItem onClick={handleReset} className="cursor-pointer focus:bg-white/10 focus:text-white">
                        <RefreshCw className="mr-2 h-4 w-4" />
                        Reset Progress
                    </DropdownMenuItem>
                    <DropdownMenuSeparator className="bg-white/10" />
                    <DropdownMenuItem onClick={handleDelete} className="cursor-pointer text-red-400 focus:text-red-300 focus:bg-red-500/10">
