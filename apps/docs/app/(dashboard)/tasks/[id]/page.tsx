...
export default function TaskDetailsPage() {
    return (
        <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(99,102,241,0.15),_transparent_38%),linear-gradient(135deg,_#020617_0%,_#111827_45%,_#0f172a_100%)] text-white">
            <div className="flex-1 flex flex-col">
                <main className="flex-1 p-4 md:p-8 overflow-auto">
                    <div className="max-w-7xl mx-auto">
                        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-indigo-500/[0.12] via-purple-500/[0.08] to-cyan-500/[0.06] p-5 md:p-6 mb-7">
