...
export default function SubjectLibraryPage() {
    ...
    return (
        <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(34,211,238,0.08),_transparent_36%),linear-gradient(135deg,_#020617_0%,_#111827_45%,_#0f172a_100%)] text-white p-6 md:p-8">
